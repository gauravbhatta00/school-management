    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_type', models.CharField(choices=[('exam', 'Exam'), ('holiday', 'Holiday'), ('meeting', 'Meeting'), ('activity', 'Activity'), ('other', 'Other')], default='other', max_length=20)),
        ...
        migrations.AddIndex(
            model_name='notice',
            index=models.Index(fields=['school', 'is_published'], name='notices_not_school__267c15_idx'),
        ),
        migrations.AddIndex(
            model_name='notice',
            index=models.Index(fields=['school', 'published_at'], name='notices_not_school__9aab63_idx'),
        ),
        migrations.AddIndex(
            model_name='calendarevent',
            index=models.Index(fields=['school', 'start_date'], name='notices_cal_school__c5a9a4_idx'),
        ),
        migrations.AddIndex(
            model_name='calendarevent',
            index=models.Index(fields=['school', 'end_date'], name='notices_cal_school__1007e8_idx'),
        ),
        migrations.AddIndex(
            model_name='calendarevent',
            index=models.Index(fields=['school', 'event_type'], name='notices_cal_school__be17a0_idx'),
        ),
    ]
