        ...
        return Response(
            {
                ...
                "by_type": {
                    "leave_requests": apps.filter(
                        application_type=Application.Type.LEAVE_REQUEST
                    ).count(),
                    "transfer_requests": apps.filter(
                        application_type=Application.Type.TRANSFER_REQUEST
                    ).count(),
                    "fee_waivers": apps.filter(
                        application_type=Application.Type.FEE_WAIVER
                    ).count(),
                    "scholarships": apps.filter(
                        application_type=Application.Type.SCHOLARSHIP
                    ).count(),
                    "other": apps.filter(
                        application_type=Application.Type.OTHER
                    ).count(),
                },
            }
        )
